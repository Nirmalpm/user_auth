...
const Carousel = ({verse,bg}) => {
  ...
  return (
    <div className="relative w-full flex justify-center items-center flex-col ">
      <h1 className="font-bold text-5xl text-gray-800">{verse.chapter_title}</h1>
        ...
        <div
            ...
            >     <strong className="text-center text-white">Verse {q.verse_number}</strong>
                <span className="flex w-full rounded-3xl   border-gray-500 shadow-lg
                  ...
                  <span className="absolute  p-2 text-white text-3xl">{q.verse} </span>
                  <span className="relative  p-2 text-white text-3xl">{q.meaning} </span>
