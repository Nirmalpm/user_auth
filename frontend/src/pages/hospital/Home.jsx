...
const Home = () => {
  return (
    <div className="flex flex-grow w-full justify-center gap-2">  
       {/* Left Panel */}
      <div className="flex border-1 border-gray-400 flex-col min-w-[250px] md:w-1/5 p-3 h-150 overflow-y-auto scrollbar-thin scrollbar-track-gray-200 scrollbar-thumb-blue-600">
      <LeftPanel />
      </div>
      <div className="flex text-2xl max-w-5xl flex-wrap w-3/5">
